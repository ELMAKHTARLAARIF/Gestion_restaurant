                    ...
                    <div style="padding:24px;display:flex;flex-direction:column;gap:20px;">
                        ...
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                            ...
                            <div>
                                ...
                                <select name="category_id" id="itemCat" class="w-full px-4 py-2.5 h-11 bg-transparent border border-white/[.1] rounded-lg text-sm text-white/80 focus:outline-none focus:border-white/30 focus:ring-1 focus:ring-white/10 transition-all duration-200 cursor-pointer appearance-none">
